...
export declare namespace EthereumClient {
    export type Options = BaseClientOptions;
}

export class EthereumClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<EthereumClient.Options>;
    ...
    constructor(options: EthereumClient.Options) {
