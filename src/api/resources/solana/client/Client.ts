...
export declare namespace SolanaClient {
    export type Options = BaseClientOptions;
}

export class SolanaClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<SolanaClient.Options>;
    ...
    constructor(options: SolanaClient.Options) {
